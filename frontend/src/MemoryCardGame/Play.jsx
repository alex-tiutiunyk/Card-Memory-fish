...
import backgroundGif from '../../public/images/bg-layer-2.jpg';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className={`${isCalmMode ? 'calm-mode-label' : ''} modal-h2`}>Background Music</h2>
        ...
        <h2 className={`${isCalmMode ? 'calm-mode-label' : ''} modal-h2`}>Sound Effects</h2>
        <div className='volume-control'>
